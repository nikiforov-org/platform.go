...
- Любые бинарники: `raw_exec` запускает любой статически слинкованный Linux-бинарник — Go, Rust, или любой другой язык со статической сборкой. Бинарник подключается к локальному NATS (`127.0.0.1:4222`), подписывается на subjects и становится полноценным участником платформы. Docker не нужен и не установлен.
